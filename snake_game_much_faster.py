...
def auto_interval(spd):
    """Convert UI speed (1-1000) to frame interval.
    Steep curve: most of the bar sits in the fast zone.
    speed=1 -> ~60 frames/move, speed=500 -> ~6, speed=1000 -> 1."""
    t = clamp(spd, 1, 1000) / 1000.0
    return max(1, round(60 ** (1.0 - t)))
